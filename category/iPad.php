...
{
	//$("#deviceImg").attr("src","../applechain_photos/applechain_photos/iPad/"+id+".png");
	$("#deviceName").html('iPad '+id);
	deviceModel = id;
}
...
<ul class="nav nav-tabs" id="myTab">
  <li class="active"><a href="#iPad1" onclick="setDevice('1');"><img src="../applechain_photos/applechain_photos/iPad/1.png" width="100" height="100" /><br /><center>iPad 1</center></a></li>
  <li><a href="#iPad2" onclick="setDevice('2');"><img src="../applechain_photos/applechain_photos/iPad/2.png" width="100" height="100" /><br /><center>iPad 2</center></a></li>
  <li><a href="#iPad3" onclick="setDevice('3');"><img src="../applechain_photos/applechain_photos/iPad/3.png" width="100" height="100" /><br /><center>iPad 3</center></a></li>
  <li><a href="#iPad4" onclick="setDevice('4');"><img src="../applechain_photos/applechain_photos/iPad/4.png" width="100" height="100" /><br /><center>iPad 4</center></a></li>
  <li><a href="#iPadmini" onclick="setDevice('Mini');"><img src="../applechain_photos/applechain_photos/iPad/5.png" width="100" height="100" /><br /><center>iPad Mini</center></a></li>
</ul>

<div class="tab-content">
  <div class="tab-pane" id="iPad1"></div>
  <div class="tab-pane" id="iPad2"></div>
  <div class="tab-pane" id="iPad3"></div>
  <div class="tab-pane" id="iPad4"></div>
  <div class="tab-pane active" id="iPadmini"></div>
</div>
 ...
 <div class="col-xs-6 col-md-3">
    <div id="searchFilter" class=" img-thumbnail" style="width:100%;">
        ...
        <label class="checkbox">
          <input type="checkbox" id="c3gs" value="3gs"> iPad 3gs
        </label>
        <label class="checkbox">
          <input type="checkbox" id="c4" value="4"> iPad 4
        </label>
        <label class="checkbox">
          <input type="checkbox" id="c4s" value="c4s"> iPad 4s
        </label>
        <label class="checkbox">
          <input type="checkbox" id="c5" value="5"> iPad Mini
        </label>
        <label class="checkbox">
          <input type="checkbox" id="5c" value="5c"> iPad Minic
        </label>
        <label class="checkbox">
          <input type="checkbox" id="5s" value="5s"> iPad Minis
        </label>-->
        <h4>Range</h4>
