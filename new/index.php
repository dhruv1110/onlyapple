...
<title>Join to AppleChain</title>
...
<div class="center_container">
  <center>
      <h1>Join to AppleChain Family</h1>
      <h5>Please enter your details in form below</h5>
  </center>
  <br />
  <form class="form-horizontal" role="form" method="post" action="register.php" id="regForm" onsubmit="return validate()">
      ...
      <div class="form-group">
        <label for="conpwd" class="col-lg-2 control-label">Confirm Password</label>
        <div class="col-lg-10">
